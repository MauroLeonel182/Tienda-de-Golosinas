...
<div id="contenedorr">
    <div id="central">
        <div id="login">
            ...
            <form id="loginform" action="<?php echo urlsite ?>?page=categoria&opcion=editar" enctype="multipart/form-data" method="post">
                ...
                <img src="public/img/categorias/<?php echo $datos[0]->urlfoto ?>" class="img-fluid" alt="Imagen Actual">
